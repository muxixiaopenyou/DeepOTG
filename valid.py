...
def run_test(test_name, seq_path, pssm_path, feat_path, result_file, max_rows=None):
    ...
    try:
        test_sequences, test_labels = load_encoding_from_fasta(seq_path, pssm_path, max_rows=max_rows)
    ...
    print(f"Data loaded. Sequences: {test_sequences.shape}, Features: {test_features.shape}")
...
run_test("Independent Test", './data/independent.txt', './db/balancedtest_pssm/pssm', './data/independent_esm.txt', 'all_independent_results.txt')
run_test("Imbalanced Independent Test", './data/imbalanced_independent.txt', './db/imbalancedtest_pssm/pssm', './data/imbalanced_independent_esm.txt', 'all_imbalanced_independent_results.txt')