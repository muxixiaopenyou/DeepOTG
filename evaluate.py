...
# assume your file name is test.txt, pssm files in ./db/test, and features in test_esm.txt
run_test("Test", './data/test.txt', './db/test', './data/test_esm.txt', 'test_results.txt')
